...
void Comprar_criptomoedas(float *carteira,carteira* carteiras, const char *senha,const char *cpf, int *indice);
void Vender_criptomoedas(float *carteira, carteira* carteiras, const char *cpf, int *indice);
